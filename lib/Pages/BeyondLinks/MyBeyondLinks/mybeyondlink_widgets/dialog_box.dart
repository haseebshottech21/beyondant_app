...
class CreateMyBeondLinkDialog extends StatefulWidget {
  final String title;
  final TextEditingController firstcontroller;
  final TextEditingController secondcontroller;
  final Function()? onPressed;
  final Function onChanged;
  const CreateMyBeondLinkDialog({
    required this.title,
  ...
  @override
  State<CreateMyBeondLinkDialog> createState() =>
      _CreateMyBeondLinkDialogState();
}

class _CreateMyBeondLinkDialogState extends State<CreateMyBeondLinkDialog> {
  // @override
  // void initState() {
